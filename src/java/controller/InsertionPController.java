 ...
 * @author Antsa
 */
public class InsertionPController extends HttpServlet {
         ...
         try {
            ...
            try{
                ...
                if(a.uniteok(c, unite)){
                    Sortie m=new Sortie(c,dateSortie,idarticle,quantite,idmagasin,String.valueOf(u.getIdUnite()));
                    m.insert(c);
                    response.sendRedirect("InsertionSortieController");  
                }
                else{
